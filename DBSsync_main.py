...
from PyQt5.QtWidgets import (
    ...
    QStackedWidget, QDialog, QTableWidget, QTableWidgetItem, QRadioButton, QCheckBox, QHeaderView)
...
class SyncGUI(QMainWindow):
    def __init__(self):
        ...
        self.dataset_intra = DataSet()  # Dataset for the intracranial recording (STN recordings from Percept).
        self.dataset_extra = DataSet()  # Dataset for the extracranial recording (EEG for example)

        # load configuration file for user parameters
    ...
    def create_home_page(self):
        ...
        # Layout for saving folder selection and saving datasets
        saving_folder_layout = QHBoxLayout()
        # Create a button and a label to select the folder where to save the results
        ...
        # Create a button to save the datasets
    ...
    def create_panel_intra(self):
        ...
        # Channel selection button for intracranial file
        ...
        # Plot channel button for intracranial files
        ...
        # Plot artifact detection button for intracranial (Initially disabled)
        self.btn_artifact_detect_intra = Button("Automatic detection synchronization artifact", "lightblue")
        self.btn_artifact_detect_intra.setEnabled(False)  # Initially disabled
    ...
    def create_xdf_panel(self):
        """Create the right panel for .xdf/.fif/POLY5 file processing."""
        layout = QVBoxLayout()
        ...
        # Channel selection button for external (Initially hidden)
        ...
        # Plot artifact detection button for external bipolar channel (Initially disabled)
        self.btn_artifact_detect_xdf = Button("Automatic detection synchronization artifact", "lightgreen")
        self.btn_artifact_detect_xdf.setEnabled(False)  # Initially disabled
        ...
        # Optional heart rate computation from ECG channel
        ...
        # Add channel layout to main layout for external
    ...
    def create_timeshift_page(self):
        ...
        self.canvas_synced.setEnabled(False)  # Initially disabled
        ...
        # Buttons and labels to select the last artifacts in both recordings
        ...
        self.btn_select_last_art_xdf = Button("Select last artifact in external recording", "lightgreen")
        ...
        # Compute timeshift button and label to show the computed timeshift
    ...
    def create_effective_sf_page(self):
        ...
        # Compute effective sampling frequency button and label
    ...
    def create_panel_intra_sf_correction(self):
        ...
        self.canvas_intra_sf.setEnabled(False)  # Initially disabled
        ...
        # Buttons and labels to select the first and last artifacts in intracranial recording
    ...
    def create_panel_extra_sf_correction(self):
        ...
        # Buttons and labels to select the first and last artifacts in external recording
    ...
    def create_ecg_cleaning_page(self):
        ...
        # Button and label to choose the intracranial channel to clean
        ...
        # Button and label to choose the external ECG channel to help cleaning
        ...
        # Button and label to set filtering of intracranial channels before cleaning. 
        # Both channels will be filtered with the same parameters.
        ...
        # Create a horizontal layout for R-peak detection parameters and cleaning methods
        ...
        # Add a canvas to visualize detected R-peaks
        ...
        # Add a toolbar to visualize detected R-peaks
        ...
        # Add a canvas and interactive toolbar to visualize raw and cleaned signals overlapped
        ...
        # add a matplotlib canvas and toolbar to visualize the ECG artifact detected
        ...
        # add a matplotlib canvas and toolbar to visualize the power spectrum of the raw and cleaned channel
        ...
        # Create a button to confirm the cleaning
    ...
    def confirm_cleaning(self):
        """Confirm cleaning and replace raw data with cleaned data."""
    ...
    def confirm_sync(self):
        """Confirm synchronization by offsetting both recordings based on the selected artifacts.
        Stores the synced data in new attributes of the dataset objects."""
        ...
        ext_rec_offset = self.dataset_extra.raw_data.copy().crop(tmin=new_start_external, tmax=tmax_external)

        # store the synced external channels in a new object
        self.dataset_extra.synced_data = ext_rec_offset
    ...
    def update_compute_eff_sf_button_state(self):
        """Enable or disable the compute effective sampling frequency button based on artifact selection."""
        if (
    ...
    def update_plot_sync_channels_state(self):
        """Enable or disable the plot synchronized channels button based on artifact selection."""
    ...
    def update_button_styles(self, active_button):
        """Update the styles of navigation buttons to indicate the active page."""
    ...
    def update_synchronize_button_state(self):
        """Enable or disable the synchronize button based on artifact detection."""
        if self.dataset_intra.art_start is not None and self.dataset_extra.art_start is not None:
    ...
    def process_value_from_plot(self, value):
        """Function related to cardiac artifact removal functionalities.
        Process the value received from the plot window for SVD cleaning."""
        k = int(value)
        ...
        # Create a copy of raw data and loop through detected R-peaks to subtract reconstructed artifacts
        ...
        for i, peak in enumerate(self.final_peaks):
            ...
            # Build fitted template and subtract
    ...
    def show_stream_selection_dialog(self, streamings_df):
        """Show a dialog to select stream containing synchronization pulses from 
        the available streams in the XDF file."""
